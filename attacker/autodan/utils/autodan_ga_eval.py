...
def get_args():
    ...
    parser.add_argument("--API_key", type=str, default="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")
...
if __name__ == "__main__":
    ...
    model_path_dicts = {
        "llama2": "/root/codes/models/chinese-alpaca-2-7b-hf",
    ...
    for i, (g, t) in tqdm(enumerate(dataset), total=len(harmful_data.goal[args.start :])):
        ...
        with open(
            f"./results/autodan_ga/{args.model}_{args.start}_{args.save_suffix}.json",
            "w",
        ) as json_file:
